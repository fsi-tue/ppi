    ...
    function getResetPasswordField($message, $success, $i18n) {
        ...
        return '<div id="loginField">
                    ...
                    <form method="POST" action="">
                        <input type="text" id="username" name="username" placeholder="' . $i18n->get('userZxShort') . '"' . $color . ' maxlength="7" autocomplete="username" autocapitalize="none" spellcheck="false" required>
